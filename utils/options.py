...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument('--problem_type', type=str, default='binary', choices=['binary', 'parts', 'instruments'])
        self.parser.add_argument('--model', type=str, default='UNet', choices=model_list.keys())
