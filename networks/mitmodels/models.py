...
class UNet16(nn.Module):
    def __init__(self, in_channels=3, classes=1, num_filters=32, pretrained=True):
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
...
class LinkNet34(nn.Module):
    def __init__(self, in_channels=3, classes=1, num_channels=3, pretrained=True):
        super().__init__()
...
class UNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.down.append(self.module(in_channels, down_filter_sizes[0]))
        ...
        if add_output:
            self.conv_final = nn.Conv2d(up_filter_sizes[0], classes, 1)
