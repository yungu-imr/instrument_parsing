...
class ICNet(SegBaseModel):
    ...
    def __init__(self, in_channels=3, classes=19, backbone='resnet50', pretrained_base=True):
        super(ICNet, self).__init__(classes, backbone, pretrained_base=pretrained_base)
