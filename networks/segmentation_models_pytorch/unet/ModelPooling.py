...
from ..base import SegmentationModelMultiHeadPool
from ..base import SegmentationHead, ClassificationHead
from ..base import PoolContourHead

class UnetP(SegmentationModelMultiHeadPool):
    ...
    def __init__(
        ...
        self.pool_head = PoolContourHead(
            input_channel=classes_mask,
            output_channel=classes_contour,
            kernel_size=5,
        )

        self.real_pool_head = PoolContourHead(
            input_channel=classes_mask,
            output_channel=classes_contour,
            kernel_size=5,
        )
